...
final class Version20231101184957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reakce (id INT NOT NULL, odkoho_id INT DEFAULT NULL, komu_id INT DEFAULT NULL, odkazovany_prispevek_id INT DEFAULT NULL, odpoved_na_id INT DEFAULT NULL, recenze_id INT DEFAULT NULL, typ VARCHAR(255) NOT NULL, text VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_12EAEC40126696F1 ON reakce (odkoho_id)');
        $this->addSql('CREATE INDEX IDX_12EAEC40493C859E ON reakce (komu_id)');
        $this->addSql('CREATE INDEX IDX_12EAEC405999238 ON reakce (odkazovany_prispevek_id)');
        $this->addSql('CREATE INDEX IDX_12EAEC40766690AC ON reakce (odpoved_na_id)');
        $this->addSql('CREATE INDEX IDX_12EAEC40944CB075 ON reakce (recenze_id)');
        ...
        $this->addSql('ALTER TABLE reakce ADD CONSTRAINT FK_12EAEC40126696F1 FOREIGN KEY (odkoho_id) REFERENCES osoba (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE reakce ADD CONSTRAINT FK_12EAEC40493C859E FOREIGN KEY (komu_id) REFERENCES osoba (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE reakce ADD CONSTRAINT FK_12EAEC405999238 FOREIGN KEY (odkazovany_prispevek_id) REFERENCES prispevek (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE reakce ADD CONSTRAINT FK_12EAEC40766690AC FOREIGN KEY (odpoved_na_id) REFERENCES reakce (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE reakce ADD CONSTRAINT FK_12EAEC40944CB075 FOREIGN KEY (recenze_id) REFERENCES recenze (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reakce DROP CONSTRAINT FK_12EAEC40126696F1');
        $this->addSql('ALTER TABLE reakce DROP CONSTRAINT FK_12EAEC40493C859E');
        $this->addSql('ALTER TABLE reakce DROP CONSTRAINT FK_12EAEC405999238');
        $this->addSql('ALTER TABLE reakce DROP CONSTRAINT FK_12EAEC40766690AC');
        $this->addSql('ALTER TABLE reakce DROP CONSTRAINT FK_12EAEC40944CB075');
