...
class Post
{
    ...
    public function setPostDocFile(?File $postDocFile = null): void
    {
        $this->postDocFile = $postDocFile;
    ...
    public function getPostDocFile(): ?File
    {
        return $this->postDocFile;
    }

    public function setPostDocName(?string $postDocName): void
    {
        $this->postDocName = $postDocName;
    }

    public function getPostDocName(): ?string
    {
